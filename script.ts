{
  ...
  const titleClickHandler = function (this: HTMLLinkElement, event: Event): void {
    ...
    const clickedElement: HTMLLinkElement = this;

    /* find active link and make it inactive */
    const activeLink: HTMLElement = document.querySelector('.titles a.active') as HTMLLinkElement;
...
//       /* split tags into array */
  ...
  const generateAuthors = (): void => {
    ...
    const authorList: Element | null = document.querySelector(selectorAuthorsList);
